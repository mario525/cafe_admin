...
<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container md:right">
        <div class="w-full md:w-64">
            <div class="relative">
                <input type="hidden" name="date" x-ref="date">
                <input type="text" id="datepicker" readonly x-model="datepickerValue" @click="showDatepicker = !showDatepicker"
                ...
                <div class="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0" style="width: 17rem; z-index: 2;"
